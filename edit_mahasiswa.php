...
<div class="container">
        ...
        <input type="hidden" name="id_mahasiswa" value="<?php echo $data['id_mahasiswa']?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mk" class="form-control" id="mata_kuliah" placeholder="" value="<?php echo $data['mata_kuliah']?>">
            </div>
            <div class="form-group">
            ...
            <input type="submit" name="input" class="btn btn-info" value="update">
            <br>
            <br>
            <br>
        </form>
